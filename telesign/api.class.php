...
class Telesign {
	...
	protected $post_variables = array();
	protected $raw_response = "";
	protected $curl_error_num = false;
	protected $curl_error_desc = false;
	 ...
	 */
	public function verify($phone_number, $verify_code, $service = "call", $options = array()) {
...
class Verify extends Telesign {
	 ...
	 * @return string The fully formed response object repersentation of the JSON reply
	 */
	public function smart($phone_number, $verify_code = "", $options = array()) {
                
		return $this->verify($phone_number, $verify_code, 'smart', $options);
	}
	 ...
	 * @return string The fully formed response object repersentation of the JSON reply
	 */
	public function call($phone_number, $verify_code = "", $options = array()) {
		
		return $this->verify($phone_number, $verify_code, 'call', $options);
	}
	 ...
	 * @return string The fully formed response object repersentation of the JSON reply
	 */
	public function sms($phone_number, $verify_code = "", $options = array()) {

		return $this->verify($phone_number, $verify_code, 'sms', $options);
	}
